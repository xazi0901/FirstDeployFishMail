...
public class SendEmailService {
  ...
  private ClientEmailConfiguration emailConfiguration;
    ...
    // public void sendScheleduledEmail(EmailRequest emailRequest){
    //     String setToMail = "kamilkarp22@gmail.com";
    //     String subjectMail = emailRequest.getTitle();
    //     SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
    //     simpleMailMessage.setFrom("\"POLONARKO\" <komityw@polonarko.com>");
    //     simpleMailMessage.setSubject(subjectMail);
    //     // simpleMailMessage.setText(emailRequest.getBody());
    //     simpleMailMessage.setText("http://localhost:9000/images/lightIcon.png");
    ...
    //     public void sendScheleduledEmail(){
    //     String setToMail = "kamilkarp22@gmail.com";
    //     // String subjectMail = emailRequest.getTitle();
    //     SimpleMailMessage simpleMailMessage = new SimpleMailMessage();
    //     simpleMailMessage.setFrom("\"POLONARKO\" <komityw@polonarko.com>");
